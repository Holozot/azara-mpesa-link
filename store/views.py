...
def store(request, category_slug=None):
    ...
    if category_slug != None:
        if category_slug == 'haircare':
            ...
            except Category.DoesNotExist: products = Product.objects.none()
    ...
    context = {'products': paged_products, 'categories': categories, 'product_count': product_count, 'current_category': current_category}
...
def search(request): 
    ...
    if 'keyword' in request.GET:
        ...
        else: current_category = 'All Products'
    else: current_category = 'All Products'
    return render(request, 'store/store.html', {'products': products, 'product_count': product_count, 'categories': categories, 'current_category': current_category})
